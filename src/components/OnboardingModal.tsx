...
import { Sparkles, BrainCircuit, Mic, Swords, CheckCircle2, ArrowRight, X } from 'lucide-react';
...
export const OnboardingModal: React.FC<OnboardingModalProps> = ({ onClose, onOpenAuth }) => {
  ...
  const steps = [
    {
      title: 'Memorização Inteligente SRS SM-2',
      subtitle: 'Retenção Máxima sem Esforço',
      description: 'O algoritmo científico ajusta o intervalo das revisões baseado na sua facilidade. Nunca mais esqueça um conceito antes da prova ou reunião.',
      icon: BrainCircuit,
      badge: 'Neurociência Aplicada',
      color: 'from-blue-600 to-indigo-600',
    },
    {
      title: 'IA Geradora de Flashcards',
      subtitle: 'De PDF, Vídeos do YouTube e Anotações',
      description: 'Cole seu texto ou link do YouTube e deixe o Gemini 3.6 Flash criar de forma estruturada seus cartões de estudo em segundos com tópicos e explicações.',
      icon: Sparkles,
      badge: 'Modelos Gemini 3.6',
      color: 'from-amber-500 to-orange-600',
    },
    {
      title: 'Assistente de Voz & Arena de Duelos',
      subtitle: 'Estude Conversando ou Desafiando Colegas',
      description: 'Converse com o tutor de voz para tirar dúvidas em tempo real ou participe da Arena de Duelos PvP para testar seus conhecimentos no ranking global.',
      icon: Swords,
      badge: 'Interatividade & Gamificação',
