...
import { X, Check, Sparkles, Zap, Shield, Crown, QrCode, CreditCard, ArrowRight } from 'lucide-react';
...
export const SubscriptionModal: React.FC<SubscriptionModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-fade-in">
      <div className="relative w-full max-w-3xl bg-[#0b1a2a] border border-[#adc6ff]/30 rounded-3xl p-6 sm:p-8 text-white shadow-2xl space-y-6 max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-[#424754]/30 pb-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-xl font-extrabold text-white">Planos FlashMind AI PRO</h2>
        ...
        {paymentStep === 'plans' && (
          <div className="space-y-6">
            ...
            <div className="flex justify-center">
              <div className="p-1 rounded-2xl bg-[#122131] border border-[#424754]/30 flex items-center gap-1 text-xs">
                <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* Card 1: Free AdMob */}
              <div className="p-5 rounded-2xl bg-[#122131] border border-[#424754]/30 flex flex-col justify-between space-y-4">
                <div>
                  <span className="px-2.5 py-1 rounded-md bg-[#0b1a2a] text-[#8c91a0] text-[10px] font-mono border border-[#424754]/30 uppercase font-bold">
                    Grátis com AdMob
                  </span>
                  <div className="mt-3">
                    <span className="text-2xl font-extrabold text-white">R$ 0</span>
                    <span className="text-xs text-[#8c91a0]">/mês</span>
                  </div>
                  ...
                  <ul className="mt-4 space-y-2 text-xs text-slate-300">
                    <li className="flex items-center gap-2">
                      <Check className="w-3.5 h-3.5 text-emerald-400" /> 15 Créditos IA/mês
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="w-3.5 h-3.5 text-emerald-400" /> +10 Créditos por Anúncio AdMob
                    </li>
                    <li className="flex items-center gap-2 text-slate-400">
                      <Check className="w-3.5 h-3.5 text-slate-500" /> Anúncios em Banners
                    </li>
                  </ul>
                </div>
                ...
                <button
                  ...
                  className="w-full py-2.5 rounded-xl bg-[#0b1a2a] hover:bg-[#1c2b3c] border border-[#adc6ff]/20 text-xs font-bold text-[#adc6ff] flex items-center justify-center gap-1.5"
                >
              ...
              <div
                className={`p-5 rounded-2xl border transition-all flex flex-col justify-between space-y-4 ${
                  selectedPlan === 'monthly'
                    ...
                    : 'bg-[#122131] border-[#424754]/40 hover:border-[#adc6ff]/40'
                }`}
              >
                <div>
                  <span className="px-2.5 py-1 rounded-md bg-blue-500/20 text-[#60a5fa] text-[10px] font-mono border border-blue-500/30 uppercase font-bold">
                    PRO Mensal
                  </span>
                  <div className="mt-3">
                    <span className="text-2xl font-extrabold text-white">{pricing.monthlyPrice}</span>
                    <span className="text-xs text-[#8c91a0]">/mês</span>
                  </div>
                  <p className="text-xs text-[#8c91a0] mt-1">
                  ...
                  <ul className="mt-4 space-y-2 text-xs text-slate-200">
                    <li className="flex items-center gap-2">
                      <Check className="w-3.5 h-3.5 text-blue-400" /> Créditos de IA Ilimitados
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="w-3.5 h-3.5 text-blue-400" /> Zero Anúncios (AdMob Off)
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="w-3.5 h-3.5 text-blue-400" /> Tutor de Voz HD Ilimitado
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="w-3.5 h-3.5 text-blue-400" /> Relatórios PDF de Turmas
                    </li>
                  </ul>
                </div>
              ...
              {/* Card 3: PRO Anual (Highlighted) */}
              <div className="relative p-5 rounded-2xl bg-gradient-to-b from-[#162a45] to-[#0b1a2a] border-2 border-amber-500/60 shadow-2xl flex flex-col justify-between space-y-4">
                ...
                <div>
                  <span className="px-2.5 py-1 rounded-md bg-amber-500/20 text-amber-300 text-[10px] font-mono border border-amber-500/30 uppercase font-bold">
                    PRO Anual (Economize {pricing.annualDiscountPercent}%)
                  </span>
                  <div className="mt-3">
                    <span className="text-2xl font-extrabold text-amber-300">{pricing.annualMonthlyEquivalent}</span>
                    <span className="text-xs text-[#8c91a0]">/mês</span>
                  ...
                  <ul className="mt-4 space-y-2 text-xs text-white">
                    <li className="flex items-center gap-2">
                      <Check className="w-3.5 h-3.5 text-amber-400" /> 7 Dias de Teste Grátis
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="w-3.5 h-3.5 text-amber-400" /> Créditos de IA Ilimitados
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="w-3.5 h-3.5 text-amber-400" /> Bônus Instantâneo +5.000 XP
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="w-3.5 h-3.5 text-amber-400" /> Selo Dourado Estudante VIP
                    </li>
                  </ul>
                </div>
        ...
        {paymentStep === 'checkout' && (
          <div className="space-y-5 max-w-md mx-auto animate-fade-in">
            <div className="text-center space-y-1">
              <h3 className="text-lg font-bold text-white">Confirmação de Assinatura PRO</h3>
              <p className="text-xs text-[#8c91a0]">
                Plano Selecionado:{' '}
            ...
            <div className="p-5 rounded-2xl bg-[#122131] border border-[#424754]/30 space-y-4 text-center">
              <div className="flex items-center justify-center gap-2 text-xs font-bold text-[#60a5fa]">
            ...
            <button
              ...
              className="w-full text-center text-xs text-[#8c91a0] hover:underline"
            >
        ...
        {paymentStep === 'success' && (
          <div className="text-center space-y-4 py-8 animate-fade-in max-w-md mx-auto">
            <div className="w-16 h-16 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/40 flex items-center justify-center mx-auto shadow-2xl">
              <Crown className="w-9 h-9" />
            </div>

            <h3 className="text-xl font-extrabold text-white">Parabéns! Você agora é FlashMind PRO!</h3>
            <p className="text-xs text-slate-300">
              Seus créditos de IA agora são <strong className="text-amber-300">ILIMITADOS</strong>, todos os anúncios AdMob foram desativados e seu selo VIP está ativo.
            </p>
