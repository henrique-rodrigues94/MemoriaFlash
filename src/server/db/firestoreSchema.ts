...
export interface CardBucketDoc{subject:string;topic:string;educationLevel:EducationLevel;difficulty:CardContentType;cards:BankCard[];providerUsed:string;updatedAt:string;ttlAt:number;version?:number;contentVersion?:string;}
