...
export const translations = {
  pt: {
    ...
    adNetworkName: 'FlashMind Network',
    ...
    // Banner
    adBannerTitle: 'Mantenha o FlashMind 100% Grátis',
    ...
    // Interstitial
    adInterstitialTitle: 'FlashMind Network',
  ...
  en: {
    ...
    // Banner
    adBannerTitle: 'Keep FlashMind 100% Free',
  ...
  es: {
    ...
    adBannerTitle: 'Mantén FlashMind 100% Gratis',
  ...
  fr: {
    ...
    adBannerTitle: 'Gardez FlashMind 100% Gratuit',
  ...
  de: {
    ...
    adBannerTitle: 'Halte FlashMind 100% kostenlos',
